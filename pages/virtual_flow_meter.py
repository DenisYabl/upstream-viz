...
def app():
    ...
    with st.beta_container():
        ...
        with col2:
            ...
            st.markdown("Считается, что на скважине снижается дебит, если за последнюю неделю более чем в половине замеров "
                        "дебит был меньше режимного и величина отклонения превышала допустимую. Допустимые величины отклонений"
                        "задаются в справочнике и зависят от номинала ЭЦН и обводненности скважины")
