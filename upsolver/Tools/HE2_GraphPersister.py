import upsolver.Tools.HE2_ABC
from upsolver.Tools.HE2_ABC import oil_params
import upsolver.GraphEdges.HE2_Pipe as he2_pipe
from upsolver.GraphEdges.HE2_Plast import HE2_Plast
from upsolver.GraphEdges.HE2_WellPump import HE2_WellPump
import upsolver.Fluids.HE2_Fluid as he2_fluid
import upsolver.GraphNodes.HE2_Vertices
...
def fluid_to_dict(fluid):
    ...
    if class_alias in ['DummyOil', 'OilWater']:
        flds = upsolver.Tools.HE2_ABC.fieldlist
...
def dict_to_fluid(obj_dict):
    ...
    if class_alias == 'OilWater':
        ...
        oil_params = upsolver.Tools.HE2_ABC.oil_params(**obj_dict)
